...
import com.somnus.cloud.provider.api.service.hystrix.UacUserTokenFeignApiHystrix;
import com.somnus.cloud.security.feign.OAuth2FeignAutoConfiguration;

/**
 * @ClassName: UacUserTokenFeignApi
 * @Description: The interface Uac user token feign api.
 * @author Somnus
 * @date 2018年10月16日
 */
@FeignClient(value = "cloud-provider-uac", configuration = OAuth2FeignAutoConfiguration.class, fallback = UacUserTokenFeignApiHystrix.class)

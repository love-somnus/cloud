...
/**
 * @ClassName: MdcExceptionLogFeignHystrix
 * @Description: The class Mdc exception log feign hystrix.
 * @author Somnus
 * @date 2018年10月16日
 */
@Component
public class MdcExceptionLogFeignHystrix implements MdcExceptionLogFeignApi {
	...
	@Override
	public Wrapper<GlobalExceptionLogDto> saveAndSendExceptionLog(final GlobalExceptionLogDto exceptionLogDto) {
		return null;
	}
}

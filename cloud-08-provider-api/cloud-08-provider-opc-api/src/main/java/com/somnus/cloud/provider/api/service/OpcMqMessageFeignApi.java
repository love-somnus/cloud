...
import com.somnus.cloud.provider.api.service.hystrix.OpcMqMessageFeignApiHystrix;
...
/**
 * @ClassName: OpcMqMessageFeignApi
 * @Description: The interface Opc mq message feign api.
 * @author Somnus
 * @date 2018年10月16日
 */
@FeignClient(value = "cloud-provider-opc", configuration = OAuth2FeignAutoConfiguration.class, fallback = OpcMqMessageFeignApiHystrix.class)

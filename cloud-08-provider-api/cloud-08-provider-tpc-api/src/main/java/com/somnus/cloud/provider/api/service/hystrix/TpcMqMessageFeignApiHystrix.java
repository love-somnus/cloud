...
/**
 * @ClassName: TpcMqMessageFeignApiHystrix
 * @Description: The class Tpc mq message feign api hystrix.
 * @author Somnus
 * @date 2018年10月16日
 */
@Component
...
public class TpcMqMessageFeignApiHystrix implements TpcMqMessageFeignApi {
	...
	@Override
	public Wrapper<String> saveMessageWaitingConfirm(final TpcMqMessageDto mqMessageDto) {
	...
	@Override
	public Wrapper<String> saveAndSendMessage(final TpcMqMessageDto mqMessageDto) {
		return null;
	}

	@Override
	public Wrapper<String> directSendMessage(final TpcMqMessageDto mqMessageDto) {
		return null;
	}

	@Override
	public Wrapper<String> deleteMessageByMessageKey(final String messageKey) {
		return null;
	}

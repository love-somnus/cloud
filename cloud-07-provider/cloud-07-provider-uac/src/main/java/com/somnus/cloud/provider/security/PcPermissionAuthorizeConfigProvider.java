...
import com.somnus.cloud.security.core.authorize.AuthorizeConfigProvider;

/**
 * @ClassName: PcPermissionAuthorizeConfigProvider
 * @Description: The class Pc permission authorize config provider.
 * @author Somnus
 * @date 2018年10月17日
 */
@Order

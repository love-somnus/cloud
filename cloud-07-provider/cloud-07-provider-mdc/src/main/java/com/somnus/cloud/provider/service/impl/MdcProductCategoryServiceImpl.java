...
import com.somnus.cloud.provider.mapper.MdcProductCategoryMapper;
import com.somnus.cloud.provider.model.domain.MdcProductCategory;
import com.somnus.cloud.provider.model.enums.MdcCategoryStatusEnum;
...
/**
 * @ClassName: MdcProductCategoryServiceImpl
 * @Description: The class Mdc product category service.
 * @author Somnus
 * @date 2018年10月17日
 */
@Service
...
public class MdcProductCategoryServiceImpl extends BaseService<MdcProductCategory> implements MdcProductCategoryService {
	...
	public List<MdcCategoryVo> getCategoryTreeList() {
		...
		return new TreeUtils<MdcCategoryVo, Long>().getChildTreeObjects(list, 0L);
	}

...
import com.somnus.cloud.provider.mapper.PtcPayInfoMapper;
...
/**
 * @ClassName: PtcAlipayServiceImpl
 * @Description: The class Ptc alipay service.
 * @author Somnus
 * @date 2018年10月17日
 */
@Slf4j
...
public class PtcAlipayServiceImpl implements PtcAlipayService {
	...
	@Value("${cloud.alipay.callback.url}")
	private String alipayCallbackUrl;
	@Value("${cloud.alipay.qrCode.pcPath}")
	private String qrCodePcPath;
	@Value("${cloud.alipay.qrCode.qiniuPath}")
	...
	public Wrapper<?> pay(String orderNo, LoginAuthDto loginAuthDto) {
		...
		switch (result.getTradeStatus()) {
			case SUCCESS:
				...
				optUploadFileReqDto.setBucketName("cloud-oss-bucket");
